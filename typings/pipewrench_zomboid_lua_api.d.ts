...
/* File: ./src/client/ISUI/ISPanel.d.ts */
declare module 'ISUI' {
    export class ISPanel extends ISUIElement {
        /**
         * @param x (double)
         * @param y (double)
         * @param width (double)
         ...
         */
        static new(x: number, y: number, width: number, height: number): ISPanel;
...
/* File: ./src/client/ISUI/ISUIElement.d.ts */
declare module 'ISUI' {
    ...
    export class ISUIElement {
         ...
         * @returns The new ISUIElement instance.
         */
        static new(x: number, y: number, width: number, height: number): ISUIElement;
